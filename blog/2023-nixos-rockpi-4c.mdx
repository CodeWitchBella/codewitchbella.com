...
# Download the latest release of Tow-Boot for my board found at https://github.com/Tow-Boot/Tow-Boot/releases
wget https://github.com/Tow-Boot/Tow-Boot/releases/download/release-2022.07-006/radxa-RockPi4C-2022.07-006.tar.xz
# Unpack the archive
tar xf radxa-RockPi4C-2022.07-006.tar.xz
# Write it to the SBC
sudo rkdeveloptool wl 0 radxa-RockPi4C-2022.07-006/binaries/Tow-Boot.spi.bin
# Restart the SBC
