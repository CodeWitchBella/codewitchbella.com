...
needed and which are not. What I did was input the list all modules first and
...
and was back in working state again. When a deletion caused the system to no
...
not needed first, but it could be in principle done even without that.
