...
<div className="p-4 bg-orange-200 rounded-xl mt-2 -mb-2">A serious issue was found with this implementation. Please check out <a href="https://github.com/CodeWitchBella/nixos/issues/1#issuecomment-2834905133">this comment</a> before using this.</div>
