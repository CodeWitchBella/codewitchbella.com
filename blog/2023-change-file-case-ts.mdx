---
title: Change file case in typescript project
...
advocate for `kebab-case.ext` file names. However, if someone else wrote the
...
Usually I write a simple script which does exactly that and I figured I'd share
the current incarnation as a starting point for your script. Please make sure
